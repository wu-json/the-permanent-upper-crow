...
// stubby legs. Eye is a hole punched via fill-rule="evenodd".
const CROW_SVG = `<svg viewBox="0 0 100 144" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"><g fill="currentColor"><path fill-rule="evenodd" d="M50 8C62 8 70 17 70 26L100 34L70 42C78 52 86 82 86 112L86 124L80 130L76 124L70 130L66 124L60 130L56 124L50 130L46 124L40 130L36 124L30 130L26 124L20 130L14 124L14 112C14 82 22 52 30 42C30 17 38 8 50 8ZM38 28a8 8 0 1 0 16 0a8 8 0 1 0-16 0Z"/><rect x="40" y="130" width="3" height="10"/><rect x="57" y="130" width="3" height="10"/></g></svg>`;
